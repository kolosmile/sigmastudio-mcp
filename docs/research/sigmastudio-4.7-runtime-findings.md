...
Still unverified: production control-write enablement, block insertion/rename, and structural mutation acceptance on a dedicated disposable fixture. The production control-write path remains guarded even though the developer probe has passed its local HIL read-after-write/Capture/restore gate.
